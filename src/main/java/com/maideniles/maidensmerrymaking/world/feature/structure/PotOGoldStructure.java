...
public class PotOGoldStructure extends StructureFeature<JigsawConfiguration> {

    public PotOGoldStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, PotOGoldStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            LogManager.getLogger().log(Level.DEBUG, "POT O GOLD at {}!", blockpos);
        }
