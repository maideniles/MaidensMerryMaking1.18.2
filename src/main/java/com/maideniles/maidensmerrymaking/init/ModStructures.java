...
import com.maideniles.maidensmerrymaking.world.feature.structure.PotOGoldStructure;
...
public class ModStructures {
    ...
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE
            = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, MaidensMerryMaking.MOD_ID);

    /**
     * Registers the base structure itself and sets what its path is. In this case,
     * this base structure will have the resourcelocation of structure_tutorial:sky_structures.
     */
    public static final RegistryObject<StructureFeature<?>> POT_O_GOLD_STRUCTURE
            = DEFERRED_REGISTRY_STRUCTURE.register("pot_o_gold", PotOGoldStructure::new);
