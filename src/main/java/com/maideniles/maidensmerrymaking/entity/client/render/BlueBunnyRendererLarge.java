...
public class BlueBunnyRendererLarge extends GeoEntityRenderer<ColoredBunnyEntity> {

    public BlueBunnyRendererLarge(EntityRendererProvider.Context renderManager ) {
