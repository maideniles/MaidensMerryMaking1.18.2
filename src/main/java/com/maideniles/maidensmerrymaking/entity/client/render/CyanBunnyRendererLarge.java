...
public class CyanBunnyRendererLarge extends GeoEntityRenderer<ColoredBunnyEntity> {

    public CyanBunnyRendererLarge(EntityRendererProvider.Context renderManager ) {
    ...
    public ResourceLocation getTextureLocation(ColoredBunnyEntity instance) {
        return new ResourceLocation(MaidensMerryMaking.MOD_ID,"textures/entity/bunny/cyan_bunny.png");
