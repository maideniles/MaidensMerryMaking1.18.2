...
public class PurpleBunnyRendererLarge extends GeoEntityRenderer<ColoredBunnyEntity> {

    public PurpleBunnyRendererLarge(EntityRendererProvider.Context renderManager ) {
