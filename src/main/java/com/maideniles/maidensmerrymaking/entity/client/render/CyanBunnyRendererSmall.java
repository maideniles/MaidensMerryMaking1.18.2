...
public class CyanBunnyRendererSmall extends GeoEntityRenderer<ColoredBunnyEntity> {

    public CyanBunnyRendererSmall(EntityRendererProvider.Context renderManager ) {
