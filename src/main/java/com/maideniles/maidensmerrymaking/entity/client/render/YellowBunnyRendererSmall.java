...
public class YellowBunnyRendererSmall extends GeoEntityRenderer<ColoredBunnyEntity> {

    public YellowBunnyRendererSmall(EntityRendererProvider.Context renderManager ) {
