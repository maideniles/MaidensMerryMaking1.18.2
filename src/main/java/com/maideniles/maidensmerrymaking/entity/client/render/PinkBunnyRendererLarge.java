...
public class PinkBunnyRendererLarge extends GeoEntityRenderer<ColoredBunnyEntity> {

    public PinkBunnyRendererLarge(EntityRendererProvider.Context renderManager ) {
