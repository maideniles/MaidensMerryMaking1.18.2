...
public class BlueBunnyRendererSmall extends GeoEntityRenderer<ColoredBunnyEntity> {

    public BlueBunnyRendererSmall(EntityRendererProvider.Context renderManager ) {
