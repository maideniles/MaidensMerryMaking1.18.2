...
public class PurpleBunnyRendererSmall extends GeoEntityRenderer<ColoredBunnyEntity> {

    public PurpleBunnyRendererSmall(EntityRendererProvider.Context renderManager ) {
