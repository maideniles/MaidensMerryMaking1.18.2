...
public class EasterChestLootModifier extends LootModifier {
    ...
    protected EasterChestLootModifier(LootItemCondition[] conditionsIn, Item addition) {
        super(conditionsIn);
    ...
    public static class Serializer extends GlobalLootModifierSerializer<EasterChestLootModifier> {
        ...
        @Override
        public EasterChestLootModifier read(ResourceLocation name, JsonObject object, LootItemCondition[] conditionsIn) {
